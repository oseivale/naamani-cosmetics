         ...
         <div className={styles.faqs}>
          <div className={styles.infoWrapper}>
            <h1 className={styles.safetyHeader}>
              The full list of ingredients for every product is included in
              our label.
            </h1>
            ...
            <strong>Below, you will find information
              about the raw materials we use and some of their benefits.</strong>
          </div>
